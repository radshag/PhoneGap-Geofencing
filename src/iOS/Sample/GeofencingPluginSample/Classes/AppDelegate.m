...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"Geofencing launchOptions = %@", url);
    }
    ...
    //self.viewController. = invokeString;
...
// only valid if GeofencingPluginSample-Info.plist specifies a protocol to handle
